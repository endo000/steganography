...
COPY --chown=mpiuser docker/authorized_keys /home/mpiuser/.ssh/authorized_keys
RUN chmod 644 /home/mpiuser/.ssh/authorized_keys
RUN echo "PubkeyAuthentication yes" >> /etc/ssh/sshd_config
RUN echo "PasswordAuthentication  no" >> /etc/ssh/sshd_config
RUN echo "Port 2222" >> /etc/ssh/sshd_config

COPY --chown=mpiuser docker/id_rsa_docker /home/mpiuser/.ssh/
COPY --chown=mpiuser docker/config /home/mpiuser/.ssh/
